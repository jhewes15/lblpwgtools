...
workdir = os.getenv('EXEC_PATH')

# Generate some core files
out_xsec = '{}/configs/core/xsec.inc'.format(workdir)
f = open(out_xsec, 'w')
f.write('$version="3.2.13"\n\n')
f.write('/* Cross sections */\n')
f.write('cross(#CC)<\n')
f.write('        @cross_file = "{}/configs/core/xsec_cc.dat"\n'.format(workdir))
f.write('>\n\n')
f.write('cross(#NC)<\n')
f.write('        @cross_file = "{}/configs/core/xsec_nc.dat"\n'.format(workdir))
f.write('>\n')
f.close()

out_smr = '{}/configs/core/smr.inc'.format(workdir)
f = open(out_smr, 'w')
f.write('$version="3.2.13"\n\n')
f.write('/*numu dis*/\n')
f.write('energy(#dis_nue)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_nue_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_numu)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_numu_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_nut)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_nut_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_anue)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_anue_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_anumu)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_anumu_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_anut)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_anut_nominal.dat"\n'.format(workdir))
f.write('energy(#dis_NC)<>\n')
f.write('include "{}/configs/core/LBNE_dis_smear_NC_nominal.dat"\n\n'.format(workdir))
f.write('/*nue app*/\n')
f.write('energy(#app_nue)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_nue_nominal.dat"\n'.format(workdir))
f.write('energy(#app_numu)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_numu_nominal.dat"\n'.format(workdir))
f.write('energy(#app_nut)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_nut_nominal.dat"\n'.format(workdir))
f.write('energy(#app_anue)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_anue_nominal.dat"\n'.format(workdir))
f.write('energy(#app_anumu)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_anumu_nominal.dat"\n'.format(workdir))
f.write('energy(#app_anut)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_anut_nominal.dat"\n'.format(workdir))
f.write('energy(#app_NC)<>\n')
f.write('include "{}/configs/core/LBNE_app_smear_NC_nominal.dat"\n'.format(workdir))
f.close()

out_eff = '{}/configs/core/eff.inc'.format(workdir)
f = open(out_eff, 'w')
f.write('$version="3.2.13"\n\n')
f.write('include "{}/configs/core/GLB_app_FHC_eff.dat"\n'.format(workdir))
f.write('include "{}/configs/core/GLB_app_RHC_eff.dat"\n'.format(workdir))
f.write('include "{}/configs/core/GLB_dis_FHC_eff.dat"\n'.format(workdir))
f.write('include "{}/configs/core/GLB_dis_RHC_eff.dat"\n'.format(workdir))
f.close()

# Open & write GLoBES flux .inc file
out_flux = '{}/configs/flux/{}.inc'.format(workdir, flux_name)
f = open(out_flux, 'w')
...
out_config = '{}/configs/{}.glb'.format(workdir, flux_name)
f = open(out_config, 'w')
...
f.write('include "{}/configs/core/definitions.inc"\n'.format(workdir))
f.write('include "{}/configs/core/syst_list.inc"\n\n'.format(workdir))
...
f.write('/* Beam data */\n')
f.write('include "{}/configs/flux/{}.inc"\n\n'.format(workdir, flux_name))
...
f.write('/* Cross sections */\n')
f.write('include "{}/configs/core/xsec.inc"\n\n\n'.format(workdir))
...
f.write('include "{}/configs/core/smr.inc"\n\n\n\n'.format(workdir))



f.write('/* Efficiencies */\n\n')

f.write('include "{}/configs/core/eff.inc"\n\n'.format(workdir))
